...
class Server extends protocol_js_1.Protocol {
    ...
    assertTaskCapability(method) {
        var _a, _b;
        (0, helpers_js_1.assertClientRequestTaskCapability)((_b = (_a = this._clientCapabilities) === null || _a === void 0 ? void 0 : _a.tasks) === null || _b === void 0 ? void 0 : _b.requests, method, 'Client');
    }
    assertTaskHandlerCapability(method) {
        ...
        (0, helpers_js_1.assertToolsCallTaskCapability)((_a = this._capabilities.tasks) === null || _a === void 0 ? void 0 : _a.requests, method, 'Server');
    }
